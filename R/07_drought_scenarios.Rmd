...
We also remove 5% of the outliers fromt the high and low ends of the distribution, which incidentally coincide with areas of low to zero domestic well occurence.  
```{r}
diff <- (df - di)
# diff <- (d - pd)
# diff <- (d- di)
...
Initial conditions for future drougths moving forward == mean(spring and fall 2017 GWL)
```{r}
