...
- California's Central Valley is the state's most agriculturally intensive region and heavily dependent on groundwater. It is also home to nearly half of state's domestic well reliant individuals. 

- During the 2012-2016 drought, the state received nearly 2,500 domestic wells failure reports. The majority of which were in the Central Valley, leaving thousands of people without a reliable source of drinking water, which drew [national attention ](https://www.nytimes.com/2015/06/07/business/energy-environment/california-farmers-dig-deeper-for-water-sipping-their-neighbors-dry.html){target="blank"} and [state intervention ](https://www.fresnobee.com/news/local/water-and-drought/article98224037.html){target="blank"}.  
...
pal3 <- colorBin(palette = colormap(colormaps$jet, nshades = 6),
                 domain = b118cvsf$dens_100km2, bins = seq(0,6,1))
...
- Herv̩ Guillon, Research Scholar at UC Davis  
